...
You can learn to sight read with Lightspeed.
...
If you're a music student, you probably know that learning to read music is really hard.  I found that when I worked on new repertoire
...
Lightspeed will not help develop your ability to read ahead of your hands, since only one note or note combination is displayed at
a time.  It is a hardcore drill on note recognition, shape recognition and keyboard geography, and by incorporating a few rounds every morning into my
practice routine it's made a big difference in my sight reading.  I hope it helps you too.

### Future Goals: Wanna Help?

- Some fun animations.  The interface is very plain and simple at the moment and I'm no expert (yet) on WPF animation.
- Real-time audio input: would allow support for non-MIDI instruments to be added.